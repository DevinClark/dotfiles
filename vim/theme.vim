...
if &background == 'dark'
  ...
  let s:guishade1 = "#c7f3ff"
  let s:guishade2 = "#c7f3ff"
  let s:guishade3 = "#c7f3ff"
  let s:guishade4 = "#c7f3ff"
  let s:guishade5 = "#c7f3ff"
  let s:guishade6 = "#c7f3ff"
  let s:guishade7 = "#c7f3ff"
  let s:guiaccent0 = "#f59597"
  let s:guiaccent1 = "#f2b494"
  let s:guiaccent2 = "#f2db94"
  let s:guiaccent3 = "#c8f29d"
  let s:guiaccent4 = "#94f2dd"
  let s:guiaccent5 = "#94cef2"
  let s:guiaccent6 = "#db9cf7"
  let s:guiaccent7 = "#f79ce0"
  let s:ctermshade0 = 16
  let s:ctermshade1 = 195
  let s:ctermshade2 = 195
  let s:ctermshade3 = 195
  let s:ctermshade4 = 195
  let s:ctermshade5 = 195
  let s:ctermshade6 = 195
...
if &background == 'light'
  ...
  let s:guishade0 = "#dbf7ff"
  let s:guishade1 = "#c5dde6"
  let s:guishade2 = "#aec4cd"
  let s:guishade3 = "#98aab4"
  let s:guishade4 = "#81919a"
  let s:guishade5 = "#6b7781"
  let s:guishade6 = "#545e68"
  let s:guishade7 = "#3e444f"
  let s:guiaccent0 = "#e11418"
  let s:guiaccent1 = "#e0530d"
  let s:guiaccent2 = "#d2a623"
  let s:guiaccent3 = "#61ab16"
  let s:guiaccent4 = "#06b38b"
  let s:guiaccent5 = "#34a4e7"
  let s:guiaccent6 = "#a549cd"
  let s:guiaccent7 = "#cc52ad"
  ...
  let s:ctermshade6 = 241
  let s:ctermshade7 = 238
  let s:ctermaccent0 = 160
  let s:ctermaccent1 = 172
  let s:ctermaccent2 = 6
  let s:ctermaccent3 = 106
